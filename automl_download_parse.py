...
def discover_volumes():
    """Return {volume_number: year} for every AutoML volume on the PMLR index."""
...
AUTOML_VOLUMES = discover_volumes()
print("discovered AutoML volumes on PMLR: %s" % (sorted(AUTOML_VOLUMES.items()),))

try:
    pubs = loadPubs("pubs_automl")
